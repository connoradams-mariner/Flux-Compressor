...
> **Published as `flux-loom` because `loom` is already taken on crates.io.** Inside a workspace you can keep the short `loom` alias: `loom = { package = "flux-loom", version = "0.6.5" }`. <!-- x-release-please-version -->
...
loom = { package = "flux-loom", version = "0.6.5" } # x-release-please-version
arrow-array = "52"
arrow-schema = "52"
```
...
## Benchmarks (v0.6.5) <!-- x-release-please-version -->
