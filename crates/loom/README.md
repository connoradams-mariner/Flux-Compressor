...
> **Published as `flux-loom` because `loom` is already taken on crates.io.** Inside a workspace you can keep the short `loom` alias: `loom = { package = "flux-loom", version = "0.6.3" }`. <!-- x-release-please-version -->
...
## Benchmarks (v0.6.3) <!-- x-release-please-version -->
