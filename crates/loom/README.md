...
> **Published as `flux-loom` because `loom` is already taken on crates.io.** Inside a workspace you can keep the short `loom` alias: `loom = { package = "flux-loom", version = "0.5.3" }`.
...
loom = { package = "flux-loom", version = "0.5.3" }
arrow-array = "52"
arrow-schema = "52"
```
